   ...
   else if(potmode == POTMODE_DUALCHANNEL)
   {
      ...
      if(inRange1 && inRange2)
      {
		...
		// {
         ...
         //   {
        //       if(pot1nomTmp > 50.0f)
         //         pot1val = (Throttle::potmax[0] - Throttle::potmin[0]) / 2; // potval set at mid-range.
        ...
        //    }
         ...
         //   {
         //      if(pot2nomTmp > 50.0f)
         //         pot2val = (Throttle::potmax[1] - Throttle::potmin[1]) / 2;
...

{
   ...
   int uauxGain = 245; // calibrated against DVM
