...
bool Throttle::CheckAndLimitRange(int* potval, int potIdx)
{
   ...
   // Note: Inverted throttle pedal will not work as check for potpressed assumes non-inverted
   
   int potMin = potmin[potIdx]; //potmax[potIdx] > potmin[potIdx] ? potmin[potIdx] : potmax[potIdx];
