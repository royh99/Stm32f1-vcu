...
OBJSL		= $(BINARY).o hwinit.o stm32scheduler.o params.o terminal.o terminal_prj.o \
           ...
           outlanderinverter.o canhardware.o canmap.o \
           param_save.o errormessage.o stm32_can.o  utils.o terminalcommands.o  \
           chademo.o iomatrix.o bmw_sbox.o  linbus.o \
           simpbms.o outlanderCharger.o Can_OBD2.o cansdo.o outlanderDCDC.o Can_LR.o
